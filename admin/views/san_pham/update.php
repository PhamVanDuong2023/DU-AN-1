...
<form role="form" method="post" action="" enctype="multipart/form-data">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <input type="number" name="price_sp" class="form-control" value="<?=$sp['price_sp']?>" placeholder="giá">
        ...
        <div class="form-group">
            ...
            <input type="number" name="soluong_sp" class="form-control" value="<?=$sp['soluong_sp']?>" placeholder="nhập số lượng">
        ...
        <div class="form-group">
            ...
            <img src="<?= BASE_URL . $sp['img_sp']?>" width="100px" alt="">
        ...
        <div class="form-group">
            ...
            <select name="id_danhmuc" id="">
                ...
                <option value="<?=$dm['id']?>" <?= $sp['id_danhmuc']== $dm['id']? 'selected' : null ?>><?=$dm['name_danhmuc']?></option>
                <?php endforeach ?>
            </select>
        </div>
