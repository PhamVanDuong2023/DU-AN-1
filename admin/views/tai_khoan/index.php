    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                        ...
                        <tbody>
                            ...
                            foreach ($listTaiKhoan as $tkhoan) {
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td>
                                        <?php
                                        $imgPath = !empty($tkhoan['img']) ? htmlspecialchars($tkhoan['img'], ENT_QUOTES, 'UTF-8') : 'path/to/default-image.jpg';
                                        ?>
                                        <img src="../../<?php echo $imgPath; ?>" alt="Ảnh đại diện"
                                    ...
                                    <td>
                                        <a href="<?= BASE_URL_ADMIN ?>?act=taikhoan-edit&id=<?php echo $tkhoan['id'] ?>"
                                            class="label label-warning">Sửa</a>
                                        <a href="<?= BASE_URL_ADMIN ?>?act=taikhoan-delete&id=<?php echo $tkhoan['id'] ?>"
                                            class="label label-danger"
                                            onclick="return confirm('Bạn có chắc muốn xóa không ?')">Xóa</a>
                                        <a href="<?= BASE_URL_ADMIN ?>?act=chi-tiet-tai-khoan&id=<?php echo $tkhoan['id'] ?>"
                                            class="label label-warning">Chi tiết</a>
                ...
                <a href="<?= BASE_URL_ADMIN ?>?act=taikhoan-add-form-insert" class="label label-success">Thêm Tài
                    Khoản</a>
