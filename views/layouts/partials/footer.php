        ...
        <div class="row">
            <div class="col-md-4 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    <a class="text-secondary mb-2" href="<?= BASE_URL ?>"><i class="fa fa-angle-right mr-2"></i>Trang Chủ</a>
                    <a class="text-secondary mb-2" href="<?= BASE_URL ?>?act=san-pham"><i class="fa fa-angle-right mr-2"></i>Cửa Hàng Của Chúng
                        Tôi</a>
...
<div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
    <div class="col-md-6 px-xl-0">
        <p class="mb-md-0 text-center text-md-left text-secondary">
            &copy; <a class="text-primary" href="#">Tên Miền</a>. Đã Đăng Ký Bản Quyền. Thiết kế bởi
